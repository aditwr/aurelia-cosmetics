...
export default class Carousel extends Component {
  componentDidMount() {
    ...
    timeline
      ...
      .add({
        targets: ".main-img-for-carousel-hero",
        opacity: 1,
      })
      .add({
        targets: ".carousel-heading1",
        opacity: 1,
        duration: 500,
      })
      .add({
        targets: ".carousel-heading2",
        opacity: 1,
        duration: 300,
      })
      .add({
      ...
      >
        ...
        <div className="px-5 lg:px-0 pt-6 lg:w-[1200px] lg:mx-auto text-left relative z-20">
          <div className="lg:w-7/12 md:pt-4 lg:pt-16">
            <h1 className="carousel-heading1 text-3xl lg:text-[40px] font-bold font-lato mb-6 leading-tight opacity-0">
              Young cosmetics always with you, use best skin care products to
              change your life.
            </h1>
            <p className="carousel-heading2 w-10/12 md:w-8/12 text-base font-medium font-montserrat mb-8 text-slate-700 opacity-0">
          ...
          {/* main-img-for-carousel-hero */}
          <img
            src={carouselMainImg}
            alt="cosmetics"
            className="main-img-for-carousel-hero absolute opacity-0 z-0 right-0 top-0 md:bottom-0 w-48 sm:w-64 md:w-80 lg:w-[460px] translate-y-[324px] sm:translate-y-[240px] md:translate-y-[196px] lg:translate-y-[46px] md:-translate-x-[16%] lg:translate-x-0 transition-all"
          />
          {/* rectangle */}
